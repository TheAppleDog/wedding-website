...
<?php
     ...
     $category_details = Category::find_by_name($booking->wedding_type);
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h6 class="h6 mt-4 text-uppercase">OVERVIEW of <?=  $booking_detail->wedding_type?> </h6>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    <div class="card-header">Total VIP Guest</div>
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                       <h5 class="card-title">₹ <?php echo number_format((isset($booking_detail->cash_advance) && $booking_detail->cash_advance > 0) ? $booking_detail->cash_advance : 0, 2); ?></h5>
...
<div class="row">
    <div class="col-md-12 mb-3">
        <ul class="list-group">
            <div style="background-color:#FF3B77; height:45px; font-size:18px; padding-top:10px; padding-left:10px; color:white;"><b>Package Includes:</b></div>

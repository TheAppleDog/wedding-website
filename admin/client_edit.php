...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($booking_detail) {
            ...
            $booking_detail->user_name = $username;
            $booking_detail->phone = $phone;
            $booking_detail->wedding_venue = $city;
            $booking_detail->save_account();
            ...
            <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">
              <strong><i class='mdi mdi-approval'></i></strong> {$booking_detail->user_name} has been successfully modify.
...
<?php include_once 'include/sidebar.php'; ?>
                ...
                <form method="post" action="">
                    ...
                    <div class="form-row">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" name="user_name" class="form-control" id="inputusername" value="<?= $booking_detail->user_name; ?>" placeholder="Enter username">
                        </div>

   
                    <div class="form-group col-md-6">
                        <label for="inputEmail">Email</label>
                        <input type="text" name="email" class="form-control" id="inputEmail" value="<?= $booking_detail->email; ?>" placeholder="Enter email">
                    </div>
 </div>
                        ...
                        <div class="input-group col-md-6">
                            ...
                            <select class="form-control" id="wedding_type" name="wedding_type">
                                ...
                                <?php foreach($categories as $category) : ?>
                                    <?php if ($category->wedding_type == $booking_detail->wedding_type): ?>
                                        <option value="<?= $category->wedding_type;?>" selected><?= $category->wedding_type; ?> - <?=($category->price); ?> </option>
                                        <?php else: ?>
                                        <option value="<?= $category->wedding_type;?>"><?= $category->wedding_type; ?> - <?=($category->price); ?> </option>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="<?= $booking_detail->wedding_venue; ?>" id="inputcity" name="city" placeholder="Enter City">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
	...
	<div class="col form-group col-md-6">
	                        ...
	                        <input type="text" name="cash_advanced" class="form-control" value="<?= $booking_detail->cash_advance; ?>" id="inputcash_advanced" placeholder="Enter cash advanced">

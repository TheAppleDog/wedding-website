...
<nav class="navbar sticky-top p-0" style="width: 16.7%;background-color: #FF3B77; height:48px;">
    <a class="navbar-brand col-sm-3 col-md-2 mr-0" style="color:white;" href="dashboard.php">
        <!-- <img src="images/admin.png" alt="" style="width: 180px;"> -->
        CWHB Admin Panel
    </a>
</nav>
...
<div class="container-fluid">
    <div class="row">
                    ...
                    <li class="nav-item mt-3">
                        <div class="text-center">
                            <a href="users_profile.php" class="user-button">
                                <img src="<?= $users_profile->profile_picture_picture(); ?>" class="img-fluid rounded-circle" width="85" height="60" alt="">
                                <div class="user-profile" style="font-size: 18px;color:#000000;"><?= $users_profile->firstname . ' ' . $users_profile->lastname; ?></div>
                            </a>
                                <div class="text-center mt-0" style="font-size: 15px;color:#000000;">
                                    <?= ($users_profile->designation == 0) ? 'Administrator' : 'Manager'; ?>
                                </div>
                        </div>
                    </li>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10" style="margin-top: -40px;z-index: 999">
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-left:-15px;margin-right: -15px; margin-top:-9px;">

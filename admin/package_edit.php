    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="caption">Caption Of This Package</label>
                        <input type="text" name="caption" class="form-control" id="caption"  placeholder="Enter the caption" value="<?= $category->caption ?>">
                    </div>
            ...
            <div class="col-lg-4 mt-4">
                <img src="<?= $category->preview_image_picture(); ?>" width="380"   alt="">
            </div>

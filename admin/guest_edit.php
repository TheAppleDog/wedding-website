...
<?php
    ...
    $id = $_GET['id'];
    $links='id='.$id.'&booking_id='.$booking_id.'&user_name='.$user_name;
    ...
    if (isset($_POST['submit'])) {
        ...
        $gifts = clean($_POST['gifts']);
         ...
         if (empty($guestname) || empty($address) || empty($city) || empty($state) || empty($zipcode) || empty($priority) || empty($out_of_town) || empty($relationship)) {
...
<div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="5" name="gifts" class="form-control" id="inputgift"  placeholder="Enter address"><?= $guest_query->return_gifts; ?></textarea>
                    </div>

...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $gifts = clean($_POST['gifts']);
         ...
         if (empty($guestname) || empty($address) || empty($city) || empty($state) || empty($zipcode) || empty($out_of_town) || empty($relationship)) {
        ...
        $guest->return_gifts = $gifts;
        $guest->save();
        redirect_to("guest_list.php?$links");
        $session->message("
            <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">
              <strong><i class='mdi mdi-check'></i></strong> {$guest->guestname} is successfully added.
              <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                <span aria-hidden=\"true\">&times;</span>
              </button>
            </div>");
                ...
                <form method="post" action="">
                    ...
                    <div class="form-row">                        
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="city" class="form-control" style="height:38px;" id="inputstate" placeholder="Enter City">
                        </div> </div>
<div class="form-row">
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                        <label for="inputgift">Return Gifts &amp; Thank you's</label>

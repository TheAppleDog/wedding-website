...
<?php
    ...
    $user_count =  Booking::count_booking();
    $booking_count =  Booking::count_pending();
...
<!-- <div class="row">
    ...
    <div class="col-lg-3">
      <div class="card-counter primary">
        <i class="fa-regular fa-circle-check" style="margin-top:17px; font-size: 4.75em;"></i>
    ...
    <i class="fa-regular fa-hourglass-half" style="margin-top:17px; font-size: 4.75em;"></i>

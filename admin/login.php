...
<head>
    ...
    <style>
        body {
            ...
            background-color: #ffe5f7; /* Lighter shade of #ff3bb7 */
            background-size: 100%;
        }
...
<form class="form-signin" action="" method="post">
    <a href="index.php"><img class="mb-4" src="../images/logo/rings.png" width="190" ></a>
    ...
    <button class="btn btn-md btn-danger btn-block" type="submit" name="login" style="color:white; background-color:#FF3BB7;">Log In</button>

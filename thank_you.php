...
<script src="https://kit.fontawesome.com/741424920c.js" crossorigin="anonymous"></script>
 ...
 .heart-icon {
            color: red; /* Set the color you desire */
            font-size:23px;
        }
 .center-container {
            text-align: center;
...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt-5">
            <h5 class="jumbotron text-center bg-light" style="margin-top:40px; font-weight:bold;"><i class="fas fa-heart heart-icon"></i> THANK YOU FOR BOOKING WITH US. <i class="fas fa-heart heart-icon"></i><br>WE ASSURE YOU WE CAN MAKE YOUR WEDDING SUCCESSFUL.</h5>  
        </div>
<br><br><br>
<div class="center-container">
        <img src="images/bride_groom.png" style="width: 36%;
            height: 92%;
            display: inline-block;" alt="couple">
    </div>
    </div>
</div>
